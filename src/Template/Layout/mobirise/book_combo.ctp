...
<head>
    ...
    <meta name="twitter:image" content="<?= Configure::read('App.fullBaseUrl')?>/assets/habana-trinidad-cayo-coco-guillermo-ok-2000x954.jpg">

    <!-- FACEBOOK SHARE -->        
    <meta property="og:title" content="<?php echo substr($meta['title'], 0, 90)?>">
    <meta property="og:description" content="<?php echo $meta['description']?>">
    <meta property="og:image" content="<?= Configure::read('App.fullBaseUrl')?>/assets/images/habana-trinidad-cayo-coco-guillermo-ok-2000x954.jpg">
