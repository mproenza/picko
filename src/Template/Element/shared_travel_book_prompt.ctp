<div class="row" style="margin: 0px">
    <div class="col bg-light">
        <h5><?php echo __d('shared_travels', 'Reserva un taxi compartido para ir de {0} a {1}', '<code><big>'.$modality['origin'].'</big></code>','<code><big>'.$modality['destination'].'</big></code>')?></h5>
        <div>
