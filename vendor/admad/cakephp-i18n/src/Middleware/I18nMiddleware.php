...
class I18nMiddleware
{
    ...
    {   
        ...
        if (isset($params['langAdded']) && $params['langAdded']) {
            $statusCode = 301;
        ...
        $lang = isset($params['lang']) ? $params['lang'] : $this->detectLanguage($request, $config['defaultLanguage']);
        if (isset($langs[$lang])) {
    ...
    public function detectLanguage(ServerRequestInterface $request, $default = null)
    {
        ...
        // TODO: Read cookies to see if lang is available
