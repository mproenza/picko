...
<div>
    ...
    <br/>
    <b><?php echo $request['SharedTravel']['origin_short']?></b> - <b><?php echo $request['SharedTravel']['destination_short']?></b> | <b><?php echo $request['SharedTravel']['departure_time_desc']?></b>
    <br/>
    <b><?php echo $request['SharedTravel']['people_count']?> pax</b>: <?php echo $request['SharedTravel']['name_id']?></div>
