...
<p>
    <?php echo __d('shared_travels', 'Buenas noticias: su viaje desde {0} hasta {1} el día {2} ya fue gestionado y confirmado.', '<b>'.$request['SharedTravel']['origin'].'</b>', '<b>'.$request['SharedTravel']['destination'].'</b>', '<b>'.TimeUtil::prettyDate($request['SharedTravel']['date'], false).'</b>')?> 
</p>

<p>
    
    
    <?php echo __d('shared_travels', 'El chofer le recogerá en esa fecha a las {0} en {1}.', '<b>'.$request['SharedTravel']['departure_time_desc'].'</b>', '<b>'.$request['SharedTravel']['address_origin'].'</b>')?>
...
<p>
    <?php echo __d('shared_travels', 'Le deseo un feliz viaje a Cuba y un cómodo recorrido hasta {0}', $request['SharedTravel']['destination'])?>,
</p>
