            ...
            <div class="row">
                <div class="col-md-8 offset-md-2 value-proposition">
                    ...
                    <h1 style="text-align: center">
                        <big><?php echo __d('viazul', '¿No puedes reservar el bus Viazul en {0} porque los asientos se vendieron ya?', '<code style="background-color:inherit"><big><b>Cuba</b></big></code>')?></big>
                    </h1>
                    <br/>
                    <h2 class="h4" style="text-align: center"><?php echo __d('viazul', 'Prueba nuestro servicio de taxi compartido y disfruta de precios similares... no tienes que ir a la estación porque te recogemos en tu casa u hotel') ?></h2>
                    <hr/>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-10 offset-md-1 we-offer">
                <h4 class="center"><?php echo __d('viazul', '<b>PickoCar es un servicio de taxi compartido en {0}</b> como alternativa al bus Viazul, que te permitirá llegar a tus destinos por excelentes precios', '<code style="background-color:inherit"><big>Cuba</big></code>') ?></h4>
                <br/>
                <h6 class="center"><?php echo __d('viazul', 'Si no alcanzas pasaje')?> • <?php echo __d('viazul', 'Si prefieres viajar rápido')?> • <?php echo __d('viazul', 'Si no quieres pagar precios altos por taxi privado')?></h6>
                <br/>
                <br/>
                <ul class="fa-ul">
                    <li><i class="fa-li fa fa-check"></i><big><?php echo __d('viazul', '<b>Ahorra dinero</b> si viajas solo, en pareja o son tres personas y no logras reservar Viazul, pero tampoco quieres pagar el viaje completo en un taxi privado como si fueran cuatro personas.') ?></big></li>
